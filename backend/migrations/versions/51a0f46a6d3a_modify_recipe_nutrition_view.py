...
Revision ID: 51a0f46a6d3a
Revises: dc367bf04b52
Create Date: 2026-02-06 13:13:38.997811
...
revision: str = '51a0f46a6d3a'
down_revision: Union[str, Sequence[str], None] = 'dc367bf04b52'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.execute("""
        DROP VIEW recipe_nutrition_view;
